...
func TestHttpGet(t *testing.T) {
	url := "https://www.baidu.com/todos/1"
...
func TestHttpPost(t *testing.T) {
	...
	bodyParams, _ := jsoniter.Marshal(todo)

	resp, _ := HttpPost(url, header, nil, bodyParams)
	t.Log("response: ", resp)
}

func TestHttpPostFormData(t *testing.T) {
	apiUrl := "https://www.baidu.com/todos"
	header := map[string]string{
...
func TestHttpClient_Get(t *testing.T) {
	t.Parallel()
	request := &HttpRequest{
		RawURL: "https://www.baidu.com/todos/1",
		Method: "GET",
	}
...
func TestHttpClent_Post(t *testing.T) {
	...
	request := &HttpRequest{
		RawURL:   "https://www.baidu.com/todos",
		Method:   "POST",
		Headers:  header,
		FormData: postData,
	}
